...
const RaisePo = (props) => {
  ...
  const [defaultValues, setDefaultValues] = useState({
    ...
    languageId: props?.selectedLanguage?.[0]?.id || null,
    poNumber: '',
    talentId: null,
    details: '',
    oneOffCost: '',
  ...
  useEffect(() => {
    ...
    if (data) {
      ...
      if (selectedProjectData.length) {
        ...
        const langId =
          lang.length > 0
            ? (props.languages || []).filter((d) => d.name === lang[0])
            : [];
        setDefaultValues({
          ...defaultValues,
          languageId: langId.length > 0 ? langId[0].id : '',
        });
      }
    }
                          ...
                          <CustomSelect
                            ...
                            onChange={(value) => {
                              ...
                              if (selectedProjectData.length) {
                                ...
                                setFieldValue(
                                  'languageId',
                                  langId.length > 0 ? langId[0]?.id : null,
                                );
                              }
                            }}
                      ...
                      <div className="side-form-group">
                        ...
                        <div className={'mt-1 ' + classNames['mode-select']}>
                          <CustomSelect
                            ...
                            value={values.languageId || selectedLanguage}
                            unselect={false}
                          />
                          {errors.languageId &&
                            Object.keys(touched).length > 0 && (
                    ...
                    <div className="col-md-12 pl-0 pr-0">
                      <div className="side-form-group ">
                        ...
                        <div className={'mt-1 d-flex'}>
                          ...
                          <div className="d-block mr-2" style={{width: '5rem'}}>
                            <input
                              type="number"
                              name="rate"
                              autoComplete="off"
