...
import classNames from '../../../calendar/calendar.module.css';
import {updatedDefaultSlots} from '../../../calendar/sampleCalendarData';

import {fetchAuditionSlotsOfRooms} from './audition.api';
const ScheduleCalendarNew = ({
  roomsList,
  onRoomSelect,
  studioRoomId,
  selectedDate,
  ...
  const [allAuditionSlots, setAllAuditionSlots] = useState([]);
  ...
  useEffect(() => {
    ...
    getfetchAuditionSlotsOfRooms(date, selectedStudioId);
  }, [selectedDate, selectedStudioId, roomsList]);

  async function getfetchAuditionSlotsOfRooms(date, selectedStudioId) {
    const [err, data] = await until(
      fetchAuditionSlotsOfRooms(date, selectedStudioId),
    );
    if (err) {
    ...
    setAllAuditionSlots(finalResult);
  }
              ...
              >
                <div className="flex-grow-1" style={{height: '95%'}}>
                  ...
                  <div
                    ...
                    style={{borderRight: '1px solid var(--border-color)'}}
                  >
                    {allAuditionSlots?.map((room, index) => {
                      return (
                        <div
                          key={room.id}
                          style={{
                          ...
                          >
                            <button type="button"
                              ...
                              style={{
                                ...
                                marginTop: '3rem',
                                marginBottom:
                                  index === allAuditionSlots?.length - 1
                                    ? '3.8rem'
                                    : null,
                                      ...
                                      if (
                                        ...
                                        allSlotDivs.forEach((d) => {
                                          ...
                                          if (
                                            ...
                                            d.style.backgroundColor = '#d6eba6';
                                          } else {
...
export default ScheduleCalendarNew;
