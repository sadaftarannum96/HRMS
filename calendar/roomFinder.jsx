...
import classNames from '../projects/projectTabs/session/session.module.css';
import DatePicker from 'react-datepicker';
import {Formik} from 'formik';
import moment from 'moment';
import * as yup from 'yup';
import {until, mapToLabelValue, closeCalendarOnTab} from '../helpers/helpers';
...
const RoomFinder = ({sessionData, roomFinderData}) => {
  ...
  useEffect(() => {
    if (Object.keys(roomFinderData).length) {
      roomFinderData.sessionDate = roomFinderData.sessionDate
        ...
        : moment().toDate();
      roomFinderData.studio_id = roomFinderData.studio_id
          ...
          return (
            <form onSubmit={handleSubmit} autoComplete="off">
              <div className="d-flex">
                <div className={'pl-0 pr-4 ' + classNames['studio-select']}>
                ...
                <div className={'pl-0 pr-4 ' + classNames['date-select']}>
                  <div className="side-form-group">
                    <label>Date*</label>
                ...
                <div className={'pl-0 pr-4 ' + classNames['start-end-select']}>
                  <div className="side-form-group">
                ...
                <div className={'pl-0 pr-4 ' + classNames['duration-select']}>
                  <div className="side-form-group">
