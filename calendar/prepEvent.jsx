...
const PrepEvent = (props) => {
  ...
  useEffect(() => {
    ...
    for (var i in props.otherMeetingData) {
      ...
      if (i === 'projectId') {
        setProjectId(props.otherMeetingData?.projectId);
      }
              ...
              <div className="d-flex flex-column flex-grow-1 pr-1">
                {/* <div className="event_box mb-2">
                  <div className="d-flex align-items-center side-form-group mb-0">
                    <label style={{marginRight: '1.5rem'}}>Select Event</label>
                    <div
                      className={
                        'events_select ' + classNames['view_select_time']
                      }
                    >
                      <Select
                        name="selectedScreen"
